   ...
   #+begin_src emacs-lisp :tangle yes :results silent
     (use-package counsel
       ...
       (("M-x" . counsel-M-x)
        ...
        ("C-c F" . my-counsel-insert-file-path)
...
*** Markdown
After the firefox 68 maj, you need to set to do some modification:
 1) type about:config
  ...
  (use-package org-capture
    ...
    (org-capture-templates
     `(("B" "Book" checkitem (file+headline "~/Org/other/books.org" "Books")
       ...
       ("S" "Learning" entry (file+headline "~/Org/other/learning.org" "Learning"),
        my/learning-template
        :empty-lines 1)

       ("P" "Linux" entry (file+headline "~/Notes/Linux/linux.org" "To Sort"),
        "** %^{subject}
  Tested on %^{OS}"
        :empty-lines 1
        ;; :unnarrowed 1
