    ...
    ((:hint nil :color red)
     ("help screen"
      (("f" json-mode-beautifyjson-reformat "Format region/buffer (C-c C-f)")
       ...
       ("t" json-toggle-boolean "Toggle true falce (C-c C-t)")
       ("k" json-nullify-sexp "Set current expression to null (C-c C-k)")
       ("i" json-increment-number-at-point "Increment the number at point (C-c C-i)")
       ("a" (insert "a") "b" :color red)
       ("d" json-decrement-number-at-point "Decrement the number at point (C-c C-d)")))))
#+end_src
