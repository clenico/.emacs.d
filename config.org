...
#+begin_src emacs-lisp :tangle yes :results silent
  (pretty-hydra-define my/hydra-Go-To-Agenda
    (:hint nil :foreign-keys warn :title "Go-To-Notes" :quit-key "q" :color blue)
    ("GTD"
     (("in" (find-file "/home/niccle27/Org/GTD/inbox.org") "Inbox")
      ("mb" (find-file "/home/niccle27/Org/GTD/maybe.org") "Maybe")
      ("pj" (find-file "/home/niccle27/Org/GTD/projects.org") "Projects")
      ("ta" (find-file "/home/niccle27/Org/GTD/tasks.org") "Tasks")
      ("ar" (find-file "/home/niccle27/Org/GTD/archive.org") "Archive"))
     "Sorted"
     (("im" (find-file "/home/niccle27/Org/Other/improve.org") "Improve")
      ("lr" (find-file "/home/niccle27/Org/Other/learning.org") "Learning")
      ("li" (find-file "/home/niccle27/Org/Other/links.org") "Links")
      ("or" (find-file "/home/niccle27/Org/Other/orders.org") "Orders")
      ("mo" (find-file "/home/niccle27/Org/Other/movies.org") "Movies"))
     "Organisation"
     (("cl" (find-file "/home/niccle27/Org/GTD/recurrent_checklist.org") "Check list"))
     "Journal"
     (("jo" (find-file "/home/niccle27/Org/Journal/summary.org") "Journal"))
     ))
...
#+begin_src emacs-lisp :tangle yes :results silent
  (pretty-hydra-define my/hydra-Go-To-Project
    ...
    (
     "Installing script"
     (("mj" (find-file "/home/niccle27/Documents/Projects/Install-scripts/Manjaro/Install_manjaro.org") "Manjaro.org"))
     ))
