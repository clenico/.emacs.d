    ...
    ("Personnal"
     ...
     (("E" (lambda()
      ...
      ("V" (lambda()
             (interactive)
             (eyebrowse-switch-to-window-config-2)
             (set-one-file-to-window "~/School/ma2/Esigelec/VisionParOrdinateur/Pdf/Vision par Ordinateur ISE-VA.pdf" )
             (eyebrowse-switch-to-window-config-3)
             (set-one-file-to-window "~/School/ma2/Esigelec/VisionParOrdinateur/Notes/")
             (eyebrowse-switch-to-window-config-4)
             (set-one-file-to-window "~/Notes/Matlab/matlab.org")
             (eyebrowse-switch-to-window-config-5)
             (set-one-file-to-window "~/VM Shared/")
             (eyebrowse-switch-to-window-config-2)
